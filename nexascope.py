...
def diagnose(inp: NexaInput) -> Dict[str, Any]:
    ...
    hint_pre = (
        ...
        "En el análisis completo te explicamos qué está pasando, qué cambiar primero y qué NO tocar todavía."
    )
...
if res:
    ...
    if is_pro:
        full = res["full"]
        st.markdown("---")
        st.subheader("✅ Análisis completo (PRO)")
